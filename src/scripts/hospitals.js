$(function() {
	...
	if (Modernizr.svg) {
		...
		$("div#graphics").replaceWith("<dic class='textblock'><h2 style='color:blue;'>Oops! Viewing this interactive graphic requires a newer web browser. To view the graphics, please update your browser to the most current version.</h2><img src='images/clabsi_compare.png'></div>");
	...
	function drawDotChart(dataset) {
		...
		svg.selectAll('a')
			...
			.append('title')
				.text('Click to see more detail on right');
